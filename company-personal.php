        ...
        <div class="wrapper">
            <div class="inner">
                <div class="content">
                    ...
                    <div class="bottom">
                        <div class="profile-company__drivers">
                            <div class="profile-customer__block-head">
                                <div class="title">
                                    Водители
                                </div>
                                <a href="#add-driver" data-fancybox class="additem-btn">
                                    <span class="ic add-item"></span>
                                    <p>Добавить водителя</p>
                                </a>
                            </div>
                            <div class="profile-customer__block-content">
                                <div class="profile-company__drivers--list">
                                    <div class="item">
                                        <div class="item-icon">
                        ...
                        <div class="profile-company__autos">
                            <div class="profile-customer__block-head">
                                <div class="title">
                                    Автомобили
                                </div>
                                <a href="#add-car" data-fancybox class="additem-btn">
                                    <span class="ic add-item"></span>
                                    <p>Добавить автомобили</p>
                                </a>
                            </div>
                            <div class="profile-customer__block-content">
                                <div class="profile-company__autos--list">
                                    <div class="item">
                                        <div class="item-icon">
