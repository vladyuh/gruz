            ...
            <div class="inner">
                <div class="content">
                    <a href="/" class="header-logo">
                        ...
                        <div class="header-logo--text">Транспортная<br> компания</div>
                    </a>
                    <div class="header-nav">
                        <ul>
                            <li><a id="services-toggle" href="services.php">Услуги</a></li>
                    ...
                    <div class="header-corporate">
                        ...
                        <a href="/clients.php">Юридическим<br> лицам</a>
                    </div>
                    <a href="/client-personal.php" class="profile-btn">
                        <span class="ic person"></span>
                        <div class="text">nikolai@gmail.com</div>
                    </a>
                    ...
                    <div class="header-mobile--nav">
                        ...
                        <div class="corporate">
                            <span class="ic group"></span>
                            <a href="/clients.php">Юридическим<br> лицам <span class="ic more"></span> </a>
                        </div>
                    </div>
